...
class PasswordRecovery {
    ...
    validData() {
        ...
        .should('have.text', ' Your password is successfully updated! ')
    }
    ...
    invalidData() {
        ...
        .should('have.text', 'The selected email is invalid. ');
    ...
    invalidFormat() {
        ...
        .should('have.text', registrationSelectors.invalidFormatText);
    }
